...
import { Music as CommonMusic } from '@/constants/music';
...
const EditForkFromDialog = () => {
  ...
  const [forkFromList, setForkFromList] = useState<CommonMusic[]>([]);
  const onMusicSelect = (m: CommonMusic) => {
  ...
  const onMusicRemove = (m: CommonMusic) =>
